...
from domain.orchestrator.constants.system_prompts import SYSTEM_PROMPT_FLASHCARDS
from domain.orchestrator.constants.user_prompts import USER_PROMPT_FLASHCARDS
