...
def setup_orchestrator(llm_provider: Any, fs_adapter: Any, max_iterations: int = 10) -> tuple[SupervisorNode, AgentRegistry]:
    """
    ...
    registry.register("planner_agent", factory.create_worker(planner_config))
